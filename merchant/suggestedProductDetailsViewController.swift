//
//  suggestedProductDetailsViewController.swift
//  merchant
//
//  Created by Eugenio Mercado on 2/10/18.
...
class suggestedProductDetailsViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    @IBOutlet weak var productSuccessLabel: UILabel!
    ...
    func configureEntryData(entry: Suggested1) {
        ...
        productAddedLabel.text = "\(name) has been added to your products"
    ...
    @IBAction func updateButton(_ sender: Any) {
        ...
        if (productName.text != nil) && productDescription.text != "" {
            if constantProducts.saveObject(name: productName.text!, price: Int(amountLabel.text!)!, category: productCategory.text!, size: productDescription.text!, inventory: Int(inventoryAmount)!, barcode: barcode, image: yummy as NSData) {
            }
    ...
    func nezahualcoyotl() {
        ...
        productDescription.aroundTheCornerIsThePub()
        ...
        productDescription.setLeftPaddingPoints(15)
